...
<div class="container mt-5">
	...
	<form:form action="/projects/${project.id}/edit" method="post" modelAttribute="project">
		...
		<div class="mb-3">
			...
			<form:input type="text" class="form-control" path="title" value="${currentProject.title}"/>
		</div>
		<div class="mb-3">
			<form:label for="description" class="form-label" path="description">Description:</form:label>
			<form:errors path="description" class="text-danger" />
			<form:textarea class="form-control" path="description" value="${currentProject.description}"/>
		</div>
		<div class="mb-3">
			<form:label for="dueDate" class="form-label" path="dueDate">Due Date:</form:label>
			<form:errors path="dueDate" class="text-danger" />
			<form:input type="date" class="form-control" path="dueDate" value="${currentProject.dueDate}"/>
		</div>
		<div class="in-line">
